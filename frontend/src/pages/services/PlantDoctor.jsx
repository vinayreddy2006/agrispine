        ...
        <div className="w-full">
            ...
            <div className="max-w-3xl mx-auto w-full px-6 -mt-8 relative z-20 flex-1 pb-10">
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div className="p-8">
                        {/* Image Upload Area */}
                        <div className={`w-full h-80 bg-agriBg rounded-2xl border-3 border-dashed ${preview ? 'border-teal-500' : 'border-gray-300 hover:border-teal-400 hover:bg-teal-50/30'} flex flex-col items-center justify-center overflow-hidden relative group transition-all duration-300`}>
                            {preview ? (
                                <>
                   ...
                   ${result.color === 'green' ? 'bg-green-600' :
                            ...
                            <div className="p-8 bg-agriBg/50">
