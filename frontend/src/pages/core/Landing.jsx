        ...
        <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
            ...
            <header className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    <div className="inline-block bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-400 px-4 py-1.5 rounded-full text-sm font-bold tracking-wide mb-2">
                    ...
                    <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-white leading-tight">
                        ...
                        <span className="text-green-600 dark:text-green-400">{t('landing.hero_title_2', { defaultValue: 'Modern Farmers' })}</span>
                    </h1>
                    ...
                    <div className="flex gap-4 pt-4">
                        ...
                        <button
                            onClick={() => navigate("/login")}
                            className="bg-white dark:bg-slate-800 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-slate-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition"
                        >
                            {t('auth.login_title', { defaultValue: 'Login' })}
                        </button>
                    </div>
                    <div className="pt-6 flex items-center gap-4 text-sm text-gray-400 font-medium">
                        <div className="flex -space-x-2">
                            {[1, 2, 3, 4].map(i => (
                                <div key={i} className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 border-2 border-white dark:border-slate-950"></div>
                            ))}
                        </div>
                ...
                <div className="relative">
                    ...
                    />
                    {/* Floating Badge */}
                    <div className="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 flex items-center gap-3 animate-bounce">
                        <div className="bg-green-100 dark:bg-green-900/50 p-3 rounded-full">
                            <ShieldCheck className="w-6 h-6 text-green-600 dark:text-green-400" />
                        </div>
                        <div>
                            <p className="text-xs text-gray-400 font-bold uppercase">{t('landing.status', { defaultValue: 'STATUS' })}</p>
                            <p className="text-gray-800 dark:text-white font-bold">{t('landing.secure', { defaultValue: 'Safe & Secure' })}</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            {/* --- FEATURES SECTION --- */}
            <section className="bg-agriBg dark:bg-slate-900 py-20 transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white">{t('landing.features_title', { defaultValue: 'Everything you need to grow' })}</h2>
                        <p className="text-gray-500 dark:text-gray-400 mt-3">{t('landing.features_subtitle', { defaultValue: 'Advanced tools simplified for every farmer.' })}</p>
                    </div>
            ...
            {/* --- FOOTER --- */}
            <footer className="bg-agriDark dark:bg-slate-950 border-t border-gray-200/10 dark:border-slate-800 text-green-50 py-12 transition-colors duration-300">
...
const FeatureCard = ({ icon, title, desc }) => (
    <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-xl hover:-translate-y-1 transition duration-300">
        <div className="bg-agriBg dark:bg-slate-700 w-16 h-16 rounded-2xl flex items-center justify-center mb-6">
            {icon}
        </div>
